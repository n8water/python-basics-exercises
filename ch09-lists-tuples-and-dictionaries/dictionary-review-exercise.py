...
"""
for starship, captain in captains.items():
    print(f"The {starship} is captained by {captain}")
...
captain_list = (("Enterprise", "Picard"),
    ("Voyager", "Janeway"),
    ("Defiant", "Sisko")
    )

captains = dict(captain_list)
print(captains)
