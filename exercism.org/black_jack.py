...
def value_of_ace(card_one, card_two):
    ...
    """
    result = 1
    card_one = set_value_of_ace_in_hand(card_one)
    card_two = set_value_of_ace_in_hand(card_two)
...
def set_value_of_ace_in_hand(card):
    """ Set the value of ace to 11 if already in hand otherwise return card """    
    if card == "A":
        card = "11"
    return card